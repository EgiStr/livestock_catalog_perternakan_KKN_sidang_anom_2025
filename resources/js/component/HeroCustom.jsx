...
const HeroCustom = ({name}) => {
    return (
        <div className="relative -mt-[190px] md:-mt-[100px]">
            ...
            <div className="bannerContent flex flex-col items-center justify-center z-10 relative font-bold md:mt-10  font-spaceGrotesk text-center">
                <h1 className="md:px-1 px-10 text-4xl sm:text-2xl md:text-4xl lg:text-5xl md:pt-[200px] pt-[285px] text-white mb-2">
                    {name}
                </h1>
            </div>
        </div>
